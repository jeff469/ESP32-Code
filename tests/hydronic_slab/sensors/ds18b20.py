...
class Ds18b20Bus:
    ...
    def __init__(self, data_pin=DS18B20_DATA_PIN, *, clock=None):
        self.clock = clock
        self._last_conversion_start = None
        self._roms = []
    ...
    def read_all_c(self, *, wait: bool = True):
        if wait:
    ...
    def read_named_c(self, name_map, *, wait: bool = True):
